...
function createDefaultProfile(seed?: ParserProfile | null): ParserProfileInput {
  return {
    ...
    extractionModel: seed?.extractionModel ?? "qwen2.5:3b",
    parserVersion: seed?.parserVersion ?? "pdftotext-raw-v2",
    modelVersion: seed?.modelVersion ?? "ollama-qwen2.5-3b-v1",
    promptVersion: seed?.promptVersion ?? "structured-json-v1",
    chunkVersion: seed?.chunkVersion ?? "section-first-v1",
    embeddingProvider: seed?.embeddingProvider ?? "ollama",
    embeddingModel: seed?.embeddingModel ?? "nomic-embed-text",
    embeddingVersion: seed?.embeddingVersion ?? "ollama-nomic-embed-text-v1",
